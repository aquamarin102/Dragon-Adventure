...
namespace Game.RewardSystem
{
    ...
    {
         private readonly ResourcePath _resourcePath = new ResourcePath("Prefabs/Rewards/WeeklyRewardsWindow Variant");
        private readonly ResourceController _currencyController;
        ...
        private ResourceController CreateCurrencyController(Transform placeForUi, ResourceModel currencyModel)
        {
            var currencyController = new ResourceController(currencyModel, placeForUi);
        ...
        private void ClaimReward()
        {
            ...
            switch (reward.RewardType)
            {
                case RewardType.Wood:
                    _profilePlayer.Currency.Wood += reward.CountResource;
                    break;
                case RewardType.Diamond:
                    _profilePlayer.Currency.Diamond += reward.CountResource;
                    break;
            }
